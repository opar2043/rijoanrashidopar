  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <div className="mb-12 border-l-4 border-blue-600 pl-6">
        <h1 className="text-4xl font-bold text-white uppercase tracking-tight">Blog <span className="text-blue-500">Publishing</span></h1>
        <p className="text-secondary text-xs font-bold uppercase tracking-[0.2em] mt-2 opacity-70">Draft and deploy technical articles</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="space-y-3">
          <label className="text-[10px] font-black uppercase tracking-[0.15em] text-blue-500 ml-1">Article Headline</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Image URL */}
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.15em] text-blue-500 ml-1">Cover Image Node</label>
            <div className="relative group">
              <input 
                type="url" 
          ...
          {/* Date */}
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.15em] text-blue-500 ml-1">Publication Date</label>
            <div className="relative group">
              <input 
                type="date" 
        ...
        {/* Description */}
        <div className="space-y-3">
          <label className="text-[10px] font-black uppercase tracking-[0.15em] text-blue-500 ml-1">Article Body / Abstract</label>
          <div className="relative group">
            <textarea 
              rows={8}
