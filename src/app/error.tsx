    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6">
      <div className="max-w-md w-full space-y-12 text-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            onClick={() => reset()}
            className="flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 px-6 py-4 rounded-sm text-[10px] font-black uppercase tracking-[0.2em] text-white transition-all border border-white/10"
          >
            <FaRedo size={12} /> Try Again
          </button>
          <Link
            href="/"
            className="flex items-center justify-center gap-3 bg-primary hover:bg-primary-hover px-6 py-4 rounded-sm text-[10px] font-black uppercase tracking-[0.2em] text-white transition-all border border-primary/50 shadow-xl shadow-primary/20"
          >
            Home
          </Link>
        </div>
