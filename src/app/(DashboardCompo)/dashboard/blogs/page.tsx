    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div className="border-l-4 border-blue-600 pl-6">
          <h1 className="text-3xl font-bold text-white uppercase tracking-tight">Article <span className="text-blue-500">Archives</span></h1>
          <p className="text-secondary text-[10px] font-black uppercase tracking-[0.2em] mt-1 opacity-70">Content Management System</p>
        </div>
        <Link 
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-white/5 bg-white/[0.02]">
              <th className="px-6 py-5 text-[10px] font-black text-blue-500 uppercase tracking-[0.2em]">Visual</th>
              <th className="px-6 py-5 text-[10px] font-black text-blue-500 uppercase tracking-[0.2em]">Headline</th>
              <th className="px-6 py-5 text-[10px] font-black text-blue-500 uppercase tracking-[0.2em]">Publication Date</th>
          ...
          <tbody className="divide-y divide-white/5">
            {blogs.map((blog) => (
              <tr key={blog.id} className="hover:bg-white/[0.01] transition-colors group">
                ...
                <td className="px-6 py-4">
                  <span className="text-xs font-mono text-secondary">{blog.date}</span>
                </td>
