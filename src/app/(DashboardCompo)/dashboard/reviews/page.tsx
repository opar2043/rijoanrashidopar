    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div className="border-l-4 border-blue-600 pl-6">
          ...
          <p className="text-secondary text-[10.5px] font-black uppercase tracking-[0.2em] mt-1 opacity-70">Manage your client reviews</p>
        </div>
        <Link 
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-white/5 bg-white/[0.02]">
              <th className="px-6 py-5 text-[10.5px] font-black text-blue-500 uppercase tracking-[0.2em]">Client Name</th>
              <th className="px-6 py-5 text-[10.5px] font-black text-blue-500 uppercase tracking-[0.2em]">Date</th>
              <th className="px-6 py-5 text-[10.5px] font-black text-blue-500 uppercase tracking-[0.2em]">Rating</th>
